/**
 * Client-side i18n for Focus BC static pages.
 * Locales: public/focusbc/locales/{locale}.json (path derived from this script URL).
 */
(function () {
  "use strict";

  var STORAGE_KEY = "focusbc.i18n.locale";
  var SUPPORTED = [
        ...
        SUPPORTED.forEach(function (opt) {
          ...
          btn.addEventListener("click", function () {
            ...
            loadLocale(currentLocale).then(function (f) {
              ...
              mountLangSwitches();
              window.dispatchEvent(new CustomEvent("focusbc:i18n", { detail: { locale: currentLocale } }));
            });
            details.open = false;
          });
